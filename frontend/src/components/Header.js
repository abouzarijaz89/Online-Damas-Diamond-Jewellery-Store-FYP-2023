  ...
  return (
    <header className="myheader">
      <Navbar bg="dark" variant="dark" expand="lg" collapseOnSelect>
        <Container fluid>
          <LinkContainer to="/">
            <Navbar.Brand>Damas Diamond</Navbar.Brand>
          </LinkContainer>
<LinkContainer to="/search/name/" className="text-white">
          ...
          <LinkContainer to="/required" className="text-white">
            <Nav.Link>
              <i className="fa fa-asterisk"></i> Required Product
            </Nav.Link>          
          </LinkContainer>
              ...
              {userInfo && userInfo.isAdmin && (
                <NavDropdown title="Admin" id="adminmenu">
                  ...
                  <LinkContainer to="/admin/requestlist">
                    <NavDropdown.Item>RequiredProduct</NavDropdown.Item>
                  </LinkContainer>
                </NavDropdown>
              )}
            </Nav>
